...
class ClothingsControllerTest < ActionController::TestCase
  ...
  test "should create clothing" do
    assert_difference('Clothing.count') do
      post :create, clothing: { brand: @clothing.brand, color: @clothing.color, size: @clothing.size, uid: @clothing.uid }
    end
  ...
  test "should update clothing" do
    patch :update, id: @clothing, clothing: { brand: @clothing.brand, color: @clothing.color, size: @clothing.size, uid: @clothing.uid }
    assert_redirected_to clothing_path(assigns(:clothing))
  end
