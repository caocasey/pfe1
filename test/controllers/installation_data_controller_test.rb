...
class InstallationDataControllerTest < ActionController::TestCase
  ...
  test "should create installation_datum" do
    assert_difference('InstallationDatum.count') do
      post :create, installation_datum: { appName: @installation_datum.appName, appVersion: @installation_datum.appVersion, badge: @installation_datum.badge, deviceToken: @installation_datum.deviceToken, deviceType: @installation_datum.deviceType, installationId: @installation_datum.installationId, objectId: @installation_datum.objectId, parseVersion: @installation_datum.parseVersion, timeZone: @installation_datum.timeZone }
    end
  ...
  test "should update installation_datum" do
    patch :update, id: @installation_datum, installation_datum: { appName: @installation_datum.appName, appVersion: @installation_datum.appVersion, badge: @installation_datum.badge, deviceToken: @installation_datum.deviceToken, deviceType: @installation_datum.deviceType, installationId: @installation_datum.installationId, objectId: @installation_datum.objectId, parseVersion: @installation_datum.parseVersion, timeZone: @installation_datum.timeZone }
    assert_redirected_to installation_datum_path(assigns(:installation_datum))
  end
