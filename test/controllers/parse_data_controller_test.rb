...
class ParseDataControllerTest < ActionController::TestCase
  ...
  test "should create parse_datum" do
    assert_difference('ParseDatum.count') do
      post :create, parse_datum: { ACL: @parse_datum.ACL, authdata: @parse_datum.authdata, email: @parse_datum.email, emailverified: @parse_datum.emailverified, objectId: @parse_datum.objectId, password: @parse_datum.password, username: @parse_datum.username }
    end
  ...
  test "should update parse_datum" do
    patch :update, id: @parse_datum, parse_datum: { ACL: @parse_datum.ACL, authdata: @parse_datum.authdata, email: @parse_datum.email, emailverified: @parse_datum.emailverified, objectId: @parse_datum.objectId, password: @parse_datum.password, username: @parse_datum.username }
    assert_redirected_to parse_datum_path(assigns(:parse_datum))
  end
