...
class PaymentDataControllerTest < ActionController::TestCase
  ...
  test "should create payment_datum" do
    assert_difference('PaymentDatum.count') do
      post :create, payment_datum: { cardId: @payment_datum.cardId, cardnumber: @payment_datum.cardnumber, expirationdata: @payment_datum.expirationdata, securitycode: @payment_datum.securitycode }
    end
  ...
  test "should update payment_datum" do
    patch :update, id: @payment_datum, payment_datum: { cardId: @payment_datum.cardId, cardnumber: @payment_datum.cardnumber, expirationdata: @payment_datum.expirationdata, securitycode: @payment_datum.securitycode }
    assert_redirected_to payment_datum_path(assigns(:payment_datum))
  end
