...
class SocialDataControllerTest < ActionController::TestCase
  ...
  test "should create social_datum" do
    assert_difference('SocialDatum.count') do
      post :create, social_datum: { facebookSecret: @social_datum.facebookSecret, facebookToken: @social_datum.facebookToken }
    end
  ...
  test "should update social_datum" do
    patch :update, id: @social_datum, social_datum: { facebookSecret: @social_datum.facebookSecret, facebookToken: @social_datum.facebookToken }
    assert_redirected_to social_datum_path(assigns(:social_datum))
  end
